...
class xchembku__ImageEditUx extends xchembku__UxAutoUpdate {
    COOKIE_NAME = "IMAGE_EDIT_UX";
    FETCH_IMAGE = "xchembku_guis::commands::fetch_image";
    SET_IMAGE_IS_USABLE = "xchembku_guis::commands::set_image_is_usable";
    ...
    activate() {
        var F = "xchembku__ImageEditUx::activate"
        super.activate()
        ...
        this.#pixel_ux = new xchembku__PixelUx(
            self.runtime,
            "pixel",
    ...
    set_autoid(autoid) {
        var F = "xchembku__ImageEditUx::set_autoid";
    ...
    _handle_is_usable_change(is_usable) {
        var F = "xchembku__ImageEditUx::_handle_is_usable_change";
    ...
    _handle_previous_or_next(direction) {
        var F = "xchembku__ImageEditUx::_handle_previous_or_next";
    ...
    _handle_canvas_left_click(jquery_event_object) {
        var F = "xchembku__ImageEditUx::_handle_canvas_left_click";
    ...
    _handle_canvas_right_click(jquery_event_object) {
        var F = "xchembku__ImageEditUx::_handle_canvas_right_click";
    ...
    handle_ajax_success(response, status, jqXHR) {
        var F = "xchembku__ImageEditUx::_handle_ajax_success";
    ...
    handle_spread_event(event) {
        var F = "xchembku__ImageEditUx::handle_spread_event";
    ...
    render() {
        var F = "xchembku__ImageEditUx::render";
    ...
    resize_image() {
        var F = "xchembku__ImageEditUx::resize_image";
