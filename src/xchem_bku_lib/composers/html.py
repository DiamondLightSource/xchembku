...
thing_type = "xchembku_lib.xchembku_composers.html"
...
class Html(Thing):
    ...
    def compose_lines(self, lines):
        """
        Compose a list of strings as a div with css class T_xchembku_composer_lines.
        Each line will also be a div with class T_xchembku_composer_line.
        """
        html_string = []

        html_string.append("<div class='T_xchembku_composer_lines'>")
        for line in lines:
            html_string.append(
                f"<div class='T_xchembku_composer_line'>{html.escape(line)}</div>"
            )
        html_string.append("</div><!-- T_xchembku_composer_lines -->")
