...
class Collectors(Things):
    ...
    def lookup_class(self, class_type):
        ...
        if class_type == "dls_xchembku_lib.xchembku_collectors.aiohttp":
            from xchembku_lib.collectors.aiohttp import Aiohttp

            return Aiohttp

        elif class_type == "dls_xchembku_lib.xchembku_collectors.manual":
            from xchembku_lib.collectors.manual import Manual

            return Manual

        elif (
            class_type
            == "dls_xchembku_lib.xchembku_collectors.scrape_to_database"
        ):
            from xchembku_lib.collectors.scrape_to_database import ScrapeToDatabase
