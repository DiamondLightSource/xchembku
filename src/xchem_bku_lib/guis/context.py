...
from xchembku_lib.guis.guis import Guis, xchembku_guis_set_default

logger = logging.getLogger(__name__)


thing_type = "xchembku_lib.xchembku_guis.context"


class Context(ContextBase):
    """
    Object representing an event xchembku_dataface connection.
    """
    ...
    async def aenter(self):
        ...
        xchembku_guis_set_default(self.server)
