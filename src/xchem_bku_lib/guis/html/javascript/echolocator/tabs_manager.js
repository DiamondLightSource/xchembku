...
class xchembku__TabsManager extends xchembku__UxBase {
    COOKIE_NAME = "TABS_MANAGER";
    LOAD_TABS = "xchembku_guis::commands::load_tabs";
    SELECT_TAB = "xchembku_guis::commands::select_tab";
    TAB_ID_KEYWORD = "xchembku_guis::keywords::tab_id"
    ...
    activate() {
        var F = "xchembku__TabsManager::activate";
    ...
    _handle_tabs_created(jquery_event_object, ui) {
        var F = "xchembku__TabsManager::_handle_tabs_created";

        console.log(F + ": tabs created");

        // Tell the index.js to notify the tabs about possible layout changes.
        var custom_event = new CustomEvent(xchembku__Events_TABS_CREATED_EVENT,
            {
            });
    ...
    _load() {
        var F = "xchembku__TabsManager::_load";
    ...
    switch_to_tab(tab_id) {
        var F = "xchembku__TabsManager::switch_to_tab";
    ...
    _handle_tab_selected(jquery_event_object, ui) {
        var F = "xchembku__TabsManager::_handle_tab_selected";
        ...
        var custom_event = new CustomEvent(xchembku__Events_TAB_OPENED,
            {
    ...
    handle_ajax_success(response, status, jqXHR) {
        var F = "xchembku__TabsManager::handle_ajax_success";
