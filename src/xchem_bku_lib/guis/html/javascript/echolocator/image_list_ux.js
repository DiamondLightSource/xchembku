...
class xchembku__ImageListUx extends xchembku__UxAutoUpdate {
    COOKIE_NAME = "IMAGE_LIST_UX";
    FETCH_IMAGE_LIST = "xchembku_guis::commands::fetch_image_list";
    ...
    handle_ajax_success(response, status, jqXHR) {
        var F = "xchembku__ImageListUx::_handle_ajax_success";
    ...
    _handle_filter_change(jquery_event_object) {
        var F = "xchembku__ImageListUx::_handle_filter_change"
    ...
    _load_image(autoid) {
        var F = "xchembku__ImageListUx::_load_image";
        ...
        var custom_event = new CustomEvent(xchembku__Events_IMAGE_PICKED_EVENT,
            {
    ...
    _attach_links() {
        var F = "xchembku__ImageListUx::_attach_links";
