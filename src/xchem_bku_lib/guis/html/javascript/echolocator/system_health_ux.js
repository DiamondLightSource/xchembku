...
class xchembku__SystemHealthUx extends xchembku__UxAutoUpdate {
    COOKIE_NAME = "SYSTEM_HEALTH_UX";
    GET_SYSTEM_HEALTH = "xchembku_guis::commands::get_system_health";
    ...
    activate() {
        var F = "xchembku__SystemHealthUx::activate";
    ...
    handle_ajax_success(response, status, jqXHR) {
        var F = "xchembku__SystemHealthUx::_handle_ajax_success";
