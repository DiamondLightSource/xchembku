...
class xchembku__UxBase extends common__Base {
    COMMAND = "xchembku_guis::keywords::command";
    PAYLOAD = "xchembku_guis::keywords::payload";
    ENABLE_COOKIES = "dls_servbase_api::keywords::enable_cookies";
    UPDATE_JOB = "xchembku_guis::commands::update_job";
    CANCEL_JOB = "xchembku_guis::commands::cancel_job";
    DELETE_JOB = "xchembku_guis::commands::delete_job";
    UNBLOCK_JOB = "xchembku_guis::commands::unblock_job";
    JOB_COMMENT = "comment"
    JOB_RATING = "rating"
    ...
    handle_ajax_success(response, status, jqXHR) {
        var F = "xchembku__UxBase::handle_ajax_success[" + this.plugin_link_name + "]";
    ...
    handle_ajax_failure(jqXHR, status, error_thrown) {
        var F = "xchembku__UxBase::handle_ajax_failure[" + this.plugin_link_name + "]";
    ...
    display_ajax_error(error_message) {
        var F = "xchembku__UxBase::display_ajax_error[" + this.plugin_link_name + "]";
    ...
    // -------------------------------------------------------------
    send(json_object) {
        var F = "xchembku__ImageListUx::send[" + this.plugin_link_name + "]";
    ...
    _handle_cancel_job_clicked(jquery_event_object) {
        ...
        this._request_cancel_job($cancel_job.attr("xchembku_job_uuid"));
    ...
    _request_cancel_job(xchembku_job_uuid) {

        var json_object = {}
        json_object[this.COMMAND] = this.CANCEL_JOB;
        json_object["xchembku_job_uuid"] = xchembku_job_uuid;
    ...
    _handle_delete_job_clicked(jquery_event_object) {
        ...
        this._request_delete_job($delete_job.attr("xchembku_job_uuid"));
    ...
    _request_delete_job(xchembku_job_uuid) {
    ...
    _handle_unblock_job_clicked(jquery_event_object) {
        ...
        this._request_unblock_job($unblock_job.attr("xchembku_job_uuid"));
    ...
    _request_unblock_job(xchembku_job_uuid) {
    ...
    _handle_job_comment_changed(jquery_event_object) {
        var F = "xchembku__ImageListUx::_handle_job_comment_changed[" + this.plugin_link_name + "]";

        var $textarea = $(jquery_event_object.target);

        // The xchembku_job_uuid is an attribute of the containing row.
        var $row = $textarea.closest("TR")
        var xchembku_job_uuid = $row.attr("xchembku_job_uuid")

        console.log(F +
            ": $textarea " + $textarea.length +
            ", $row " + $row.length +
            ", xchembku_job_uuid " + xchembku_job_uuid)
    ...
    _handle_job_rating_changed(jquery_event_object) {
        var F = "xchembku__ImageListUx::_handle_job_rating_changed[" + this.plugin_link_name + "]";
