var xchembku__PixelUx__UserMotionEvent = "xchembku__PixelUx__UserMotionEvent";
var xchembku__PixelUx__UserChangeEvent = "xchembku__PixelUx__UserChangeEvent";

class xchembku__PixelUx extends xchembku__UxBase {
    SET_TARGET_POSITION = "xchembku_guis::commands::set_target_position";
    ...
    set_autoid(autoid, target_position) {
        var F = "xchembku__PixelUx::set_autoid"
    ...
    render(event) {
        var F = "xchembku__PixelUx::render"
    ...
    handle_guide_motion_event(event) {
        var F = "xchembku__PixelUx::handle_guide_motion_event"
    ...
    handle_guide_change_event(event) {
        var F = "xchembku__PixelUx::handle_guide_change_event"
        ...
        var custom_event = new CustomEvent(xchembku__PixelUx__UserChangeEvent,
            {
    ...
    update_database(event) {
        var F = "xchembku__PixelUx::update_database"
