...
xchembku__UxAutoUpdate__AUTO_UPDATE_EVENT = "xchembku__UxAutoUpdate__AUTO_UPDATE_EVENT";

class xchembku__UxAutoUpdate extends xchembku__UxBase {
    ...
    _handle_auto_update_clicked(jquery_event_object) {
        var F = "xchembku__UxAutoUpdate::_handle_auto_update_clicked[" + this.plugin_link_name + "]";
    ...
    _handle_auto_update_request_timer() {
        if (this.auto_update_enabled === true) {
            ...
            let custom_event = new CustomEvent(
                xchembku__UxAutoUpdate__AUTO_UPDATE_EVENT,
                {});
    ...
    set_and_render_auto_update(enabled, dispatched_by) {
        ...
        var F = "xchembku__UxAutoUpdate::set_and_render_auto_update[" + this.plugin_link_name + "]";
    ...
    handle_ajax_success(response, status, jqXHR) {
        var F = "xchembku__UxAutoUpdate::handle_ajax_success[" + this.plugin_link_name + "]";
    ...
    // -------------------------------------------------------------
    send(json_object) {
        var F = "xchembku__UxAutoUpdate::send[" + this.plugin_link_name + "]";
