...
class Index extends xchembku__Page {
    #tabs_manager = null;
    #image_list_ux = null;
    #image_edit_ux = null;
    ...
    activate() {
        ...
        this.#tabs_manager = new xchembku__TabsManager(
            self.runtime,
            "tabs_manager",
            $("#tabs_manager_interaction_parent"));

        this.#image_list_ux = new xchembku__ImageListUx(
            self.runtime,
            "image_list",
            $("#image_list_ux_interaction_parent"));

        this.#image_edit_ux = new xchembku__ImageEditUx(
            self.runtime,
            "image_edit",
        ...
        this.#image_edit_ux.addEventListener(
            xchembku__Events_IMAGE_PREVIOUS_OR_NEXT_EVENT,
