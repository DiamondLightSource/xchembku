...
class GuiTester(BaseContextTester):
    ...
    async def _main_coroutine(self, constants, output_directory):
        ...
        gui_specification = context_configuration["xchembku_gui_specification"]
        ...
        async with context:
            ...
            response = await xchembku_guis_get_default().client_protocolj(
            ...
            with open(f"{output_directory}/{filename}", "wt") as file:
                file.write(contents)
            await xchembku_guis_get_default().client_get_file(filename)
            ...
            with open(f"{output_directory}/{filename}", "wt") as file:
                file.write(contents)
            binary = await xchembku_guis_get_default().client_get_file(filename)
